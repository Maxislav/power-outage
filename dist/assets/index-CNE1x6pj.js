...
function getSunPosition(date, lat, lng) {
  ...
  const declination = -23.44 * Math.cos(rad * (360 / 365.25 * (dayOfYear + 10)));
...
function getSunColor(angle, top = true) {
  const minAngle = -30;
  const maxAngle = 20;
...
const FirebaseAnalytics = registerPlugin("FirebaseAnalytics", {
  web: () => __vitePreload(() => import("./web-Zew7T9IM.js"), true ? [] : void 0, import.meta.url).then((m) => new m.FirebaseAnalyticsWeb())
});
const Preferences = registerPlugin("Preferences", {
  web: () => __vitePreload(() => import("./web-D7mdDoxz.js"), true ? [] : void 0, import.meta.url).then((m) => new m.PreferencesWeb())
});
...
const App = registerPlugin("App", {
  web: () => __vitePreload(() => import("./web-Cw7kn4sO.js"), true ? [] : void 0, import.meta.url).then((m) => new m.AppWeb())
});
...
//# sourceMappingURL=index-CNE1x6pj.js.map
