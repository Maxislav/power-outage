...
function isObjectEmpty(obj) {
  return obj && // Проверка на null и undefined
...
function setUserId(analyticsInstance, id, options) {
  ...
  setUserId$1(wrappedGtagFunction, initializationPromisesMap[analyticsInstance.app.options.appId], id).catch((e) => logger.error(e));
}
...
export {
  ...
  WebPlugin as W,
  ConsentType as a,
  setUserProperties as b,
  setAnalyticsCollectionEnabled as c,
  setConsent as d,
  getAnalytics as g,
  logEvent as l,
  setUserId as s
