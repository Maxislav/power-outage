...
let RootComponent = class {
  ...
  myFetch() {
    return from(myFetch()).pipe(
      ...
      tap((d) => {
        const data = d.data;
        const todayGroup = data[d.today]["GPV3.1"];
        this.render(todayGroup, this.todayEl);
        const tomorrowGrout = data[d.today + this.SEC_IN_DAY]["GPV3.1"];
        console.log(d);
...
//# sourceMappingURL=index-BnH9xDRV.js.map
